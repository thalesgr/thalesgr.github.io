...
function Barreiras (altura, largura, abertura, espaço, notificarPonto) {
    ...
    const deslocamento = 4 // DIFICULDADE DO JOGO!!!!
    this.animar = () => {
        this.pares.forEach(par => {
            ...
            const ponto = par.getX() + deslocamento >= meio 
                && par.getX() < meio
            if(ponto) notificarPonto()
...
function FlappyBird() {
    ...
    const barreiras = new Barreiras(altura, largura, 200 /* buraco*/ , 400 /*barr espaço*/,
